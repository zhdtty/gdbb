...
@ccclass
export default class ViewBeanResultDialogQM extends UIBase
{
	...
	private _NodeVideoNor : cc.Node;
	private _NodeVIdeoSure : cc.Node;
	...
	onLoad() {
		...
		this._NodeVideoNor = this.node.getChildByName("w_BtnShowVideo").getChildByName("w_NodeVideoNor");
		this._NodeVIdeoSure = this.node.getChildByName("w_BtnShowVideo").getChildByName("w_NodeVIdeoSure");
	...
	public get NodeVideoNor() : cc.Node {
		return this._NodeVideoNor;
	}
	public get NodeVIdeoSure() : cc.Node {
		return this._NodeVIdeoSure;
	}
