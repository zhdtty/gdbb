...
@ccclass
export default class ViewBeanResultDialogQY extends UIBase
{
	...
	private _BtnNorUnTouch : cc.Node;
	private _BtnNorUnTouchButtonCom : cc.Button;
	private _BtnNorGet : cc.Node;
	private _BtnNorGetButtonCom : cc.Button;
	private _layerAdv : cc.Node;
	private _advScroll : cc.Node;
	private _advScrollSpriteCom : cc.Sprite;
	private _advScrollScrollViewCom : cc.ScrollView;
	...
	onLoad() {
		...
		this._BtnNorUnTouch = this.node.getChildByName("w_BtnNorGet").getChildByName("w_BtnNorUnTouch");
		this._BtnNorUnTouchButtonCom = this._BtnNorUnTouch.getComponent("cc.Button");
		this._BtnNorGet = this.node.getChildByName("w_BtnNorGet");
		this._BtnNorGetButtonCom = this._BtnNorGet.getComponent("cc.Button");
		this._layerAdv = this.node.getChildByName("w_advScroll").getChildByName("view").getChildByName("w_layerAdv");
		this._advScroll = this.node.getChildByName("w_advScroll");
		this._advScrollSpriteCom = this._advScroll.getComponent("cc.Sprite");
		this._advScrollScrollViewCom = this._advScroll.getComponent("cc.ScrollView");
	...
	public get BtnNorUnTouch() : cc.Node {
		return this._BtnNorUnTouch;
	}
	public get BtnNorUnTouchButtonCom() : cc.Button {
		return this._BtnNorUnTouchButtonCom;
	}
	...
	public get layerAdv() : cc.Node {
		return this._layerAdv;
	}
	public get advScroll() : cc.Node {
		return this._advScroll;
	}
	public get advScrollSpriteCom() : cc.Sprite {
		return this._advScrollSpriteCom;
	}
	public get advScrollScrollViewCom() : cc.ScrollView {
		return this._advScrollScrollViewCom;
	}
